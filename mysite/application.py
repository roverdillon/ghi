...
def connect_db():
    return sqlite3.connect('C:/Users/dillo/Documents/CompSci/finalsite/mysite/ghi.db')
...
def disdbref():
    ...
    aa = conn.execute(' select * from diseaseall2010 ')
    bb = conn.execute(' select * from diseaseall2013')
    disease2010 = xx.fetchall()
    disease2013 = yy.fetchall()
    disbars = zz.fetchall()
    diseaseall2010 = aa.fetchall()
    diseaseall2013 = bb.fetchall()
    sheetdata = [[disease2010,list(map(lambda x: x[0], xx.description)),'Table: disease2010'],
                 [disease2013,list(map(lambda x: x[0], yy.description)),'Table: disease2013'],
                 [disbars,list(map(lambda x: x[0], zz.description)),'Table: disbars'],
                 [diseaseall2010, list(map(lambda x: x[0], aa.description)), 'Table: diseaseall2010'],
                 [diseaseall2013, list(map(lambda x: x[0], bb.description)), 'Table: diseaseall2013']]
    dbheader = ['Drug Tables','drug']
    return render_template('dbviewer.html', sheetdata=sheetdata, scrolling=2, dbheader=dbheader)

@app.route('/db/company/refresh')
@requires_auth
def comdbref():
    conn = sqlite3.connect('ghi.db')
    ...
    xx = conn.execute(' select * from manudis ')
    yy = conn.execute(' select * from manutot ')
    zz = conn.execute(' select * from patent2010 ')
    qq = conn.execute(' select * from patent2013')
    manudis = xx.fetchall()
    manutot = yy.fetchall()
    patent2010 = zz.fetchall()
    patent2013 = qq.fetchall()
    sheetdata = [[manudis, list(map(lambda x: x[0], xx.description)), 'Table: manudis'],
                 [manutot, list(map(lambda x: x[0], yy.description)), 'Table: manutot'],
                 [patent2010, list(map(lambda x: x[0], zz.description)), 'Table: patent2010'],
                 [patent2013, list(map(lambda x: x[0], qq.description)), 'Table: patent2013'],]
    dbheader = ['Company Tables', 'company']
    conn.close()
    return render_template('dbviewer.html', sheetdata=sheetdata, scrolling=2, dbheader=dbheader)

@app.route('/db/country/refresh')
@requires_auth
def countdbref():
    conn = sqlite3.connect('ghi.db')
    ...
    conn.execute(
        ''' CREATE TABLE country2010 (country text, total real, tb real, malaria real, hiv real, roundworm real, hookworm real, whipworm real, schistomasis real, lf real) ''')
    conn.execute(
        ''' CREATE TABLE country2013 (country text, total real, tb real, malaria real, hiv real, roundworm real, hookworm real, whipworm real, schistomasis real, onchoceriasis real, lf real) ''')

    conn.execute(
        ''' CREATE TABLE countryp2010 (country text, total real, tb real, malaria real, hiv real, roundworm real, hookworm real, whipworm real, schistomasis real, lf real) ''')
    conn.execute(
        ''' CREATE TABLE countryp2013 (country text, total real, tb real, malaria real, hiv real, roundworm real, hookworm real, whipworm real, schistomasis real, onchoceriasis real, lf real) ''')
    ...
    for i in range(3, 218):
        ...
        if country != 'nan' and country != ' nan':
    ...
    conn.commit()
    xx = conn.execute(' select * from country2010 ')
    yy = conn.execute(' select * from country2013 ')
    zz = conn.execute(' select * from countryp2010 ')
    qq = conn.execute(' select * from countryp2013')
    country2010 = xx.fetchall()
    country2013 = yy.fetchall()
    countryp2010 = zz.fetchall()
    countryp2013 = qq.fetchall()
    sheetdata = [[country2010, list(map(lambda x: x[0], xx.description)), 'Table: country2010'],
                 [country2013, list(map(lambda x: x[0], yy.description)), 'Table: country2013'],
                 [countryp2010, list(map(lambda x: x[0], zz.description)), 'Table: countryp2010'],
                 [countryp2013, list(map(lambda x: x[0], qq.description)), 'Table: countryp2013']]
    dbheader = ['Company Tables', 'company']
    conn.close()
    return render_template('dbviewer.html', sheetdata=sheetdata, scrolling=2, dbheader=dbheader)
